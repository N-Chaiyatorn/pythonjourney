...
with open("/Gittest/python_learning_after_sec_21/pythonjourney/section20_list_comprehension/resources/file_1.txt") as file1, open("/Gittest\python_learning_after_sec_21/pythonjourney/section20_list_comprehension/resources/file_2.txt") as file2:
